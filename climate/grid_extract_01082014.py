...
def PRISMtiffwrite(data,var,direc,name,Nx,Ny,cellsize,yul,xll,nbands):    
    fileformat = "GTiff"
...
#xmax = -108.20416667339001
xmax = -108.19583334006
ymin = 42.279166659379996
ymax = 46.195833324479999
AOA = [xmin, ymin, xmax, ymax] 	#xmin, ymin, xmax, ymax
for var in vararray:
	filenum = 1
	...
	for searchyear in range(BeginYear, EndYear+1): #looping through years of interest
		...
		for filenum in range(1, 15):
			...
			PRISMtiffwrite(addmatrix,var,direc,tiffname,newcols,newrows,cellsize,newyulcorner,newxllcorner,1)
