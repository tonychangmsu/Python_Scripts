...
@author: tony.chang
Extract AO data and plot seasonal and annual indices
"""
import numpy as np
import matplotlib.pyplot as plt
#initialize-------------------------------------------------------------------
"""import teleconnection data patterns"""
Index = np.genfromtxt('D:\CHANG\Climate_models\globalpatterns\AO\AOMonthly_1950_2012.txt', names=True)
