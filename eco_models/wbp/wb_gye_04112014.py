...
gcmlist = ['CanESM2', 'CCSM4', 'CESM1-BGC','CESM1-CAM5', 'CMCC-CM', 'CNRM-CM5', 'HadGEM2-AO', 'HadGEM2-CC', 'HadGEM2-ES']
#gcmlist = ['CCSM4', 'CESM1-BGC','CESM1-CAM5', 'CMCC-CM', 'CNRM-CM5', 'HadGEM2-AO', 'HadGEM2-CC', 'HadGEM2-ES']
#gcmlist = ['HadGEM2-CC', 'HadGEM2-ES']
#rcplist = ['historical']
rcplist = [45,85]
BeginYear = 1980
EndYear = 2100
...
for mod in gcmlist:
	for rcp in rcplist:
		...
		for i in varnames:
			workspace = "E:\\CMIP5\\GCM04112014\\" + mod + "\\rcp" + str(rcp) + "\\wb\\" 
	...
	for rcp in rcplist:
		for year in range(2099,2100):
			for month in range(11,-1,-1):
				oname = 'E:\\CMIP5\\GCM04112014\\' + gcm + '\\rcp' + str(rcp) + '\\wb\\vpd\\' + 'vpd_'+str(year)+'_'+str(month)+'.tif'
				nname = 'E:\\CMIP5\\GCM04112014\\' + gcm + '\\rcp' + str(rcp) + '\\wb\\vpd\\' + 'vpd_'+str(year)+'_'+str(month+1)+'.tif'
